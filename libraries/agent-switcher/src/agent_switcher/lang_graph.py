...
def invoke(
    ...
    *,
    ...
    raise NotImplementedError(
        ...
        "Use type='default' or implement agent_switcher.lang_graph.invoke."
    )
...
def invoke_stream(
    ...
    *,
    ...
    raise NotImplementedError(
        "LangGraph agent backend is not yet implemented. "
        "Use type='default' or implement agent_switcher.lang_graph.invoke_stream."
    )
...
def generate_ragas_dataset(
    ...
    *,
    ...
    raise NotImplementedError(
        "LangGraph agent backend is not yet implemented. "
        "Use type='default' or implement agent_switcher.lang_graph.generate_ragas_dataset."
    )
